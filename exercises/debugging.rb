...
def guess_number(max_number, max_attempts)
  ...
  p "The winning number is #{winning_number}"
  attempts = 0
...
# and somehow his numbers do not match what is expected. He knows you're enrolled
...
# However, the output is wrong. Without removing any code, help Josh get
# the expected output.
